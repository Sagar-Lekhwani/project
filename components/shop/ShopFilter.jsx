...
const categories = [
  { id: 1, name: "Fashion", isActive: true, link: "/shop-collection-sub" },
  { id: 2, name: "Men", isActive: false, link: "/shop-men" },
  { id: 3, name: "Women", isActive: false, link: "/shop-women" },
  { id: 4, name: "Denim", isActive: false, link: "/shop-collection-sub" },
  { id: 5, name: "Dress", isActive: false, link: "/shop-collection-sub" },
];
